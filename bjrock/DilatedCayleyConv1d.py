...
class DilatedBjorckConv1d(nn.Module):
    ...
    def _project(self) -> None:
        ...
        """
        with torch.no_grad():
            scale, self.v_vec.data = _power_iteration_conv1d_circ(self.params, self.steps, self.thres, self.v_vec)

        self.weight = _bjorck_orthonormalize_conv1d_circ(self.params / scale, self.order, self.iters, self.thres)
