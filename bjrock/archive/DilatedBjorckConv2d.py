...
from utils import _circular_pad, _bjorck_orthonormalize_conv2d_circ
...
class DilatedBjorckConv2d(nn.Module):
    ...
    def _project(self) -> None:
        ...
        """
        with torch.no_grad():
            self.weight.data = _bjorck_orthonormalize_conv2d_circ(
...
if __name__ == "__main__":
    ...
    print("Testing DilatedBjorckConv2d layer...")
    print('*' * 60)

    # hyper-parameters
    batch_size, in_height, in_width = 1, 60, 60
    order, iters, thres = 1, 20, 1e-6
