...
#SBATCH --job-name=orthcnn_preprocessor                                      # sets the job name if not set from environment
...
expname=mode_orthogonal_preprocessor_lr_${lr}

python train_preprocessor.py --lr ${lr} > logs/${expname}.log 2>&1
