...
class OrthoLinear(nn.Module):
    ...
    def __init__(self, 
        ...
        if bias:
            warnings.warn("The layer is not exactly orthogonal if bias is used.")
        ...
        assert init in ["uniform", "identical", "reverse", "permutation", "torus"], \
            "The initialization method is not supported for the orthogonal fully-connected layer."
...
if __name__ == "__main__":
    ...
    for (in_features, out_features) in [(16, 16), (16, 24), (16, 12)]:
