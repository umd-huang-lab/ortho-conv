...
class LieExpLinear(nn.Module):
    def __init__(self, in_features, out_features, 
                 bias=True, train_terms=5, eval_terms=10, init_iters=50, update_iters=1, 
                 update_freq=200, correction=0.7
    ):
        super(LieExpLinear, self).__init__()

        self.linear = LieExpConv(in_features, out_features, kernel_size = 1, stride = 1, padding = None,
